...
require (
	...
	github.com/kozmod/oniontx/gorm v0.0.0
	github.com/kozmod/oniontx/pgx v0.0.0
	github.com/kozmod/oniontx/sqlx v0.0.0
	github.com/kozmod/oniontx/stdlib v0.0.0
...
require (
	...
	github.com/kozmod/oniontx v0.3.10 // indirect
